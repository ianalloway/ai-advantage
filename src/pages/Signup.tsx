      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          <section className="rounded-[30px] border border-white/10 bg-white/[0.03] p-8">
            <p className="text-xs uppercase tracking-[0.22em] text-yellow-300/80">Create Account</p>
            <h1 className="mt-3 text-4xl font-black tracking-tight">Pick your username and claim your profile.</h1>
            <p className="mt-4 text-base leading-7 text-zinc-400">
              Your account gives the site a stable identity for your profile, desk preferences, and future personalized workflows. Your username becomes the headline on your profile page.
            </p>
            ...
            <div className="mt-6 space-y-3">
              {[
                ...
                <div key={item} className="flex items-start gap-3 rounded-2xl border border-white/10 bg-black/20 p-4 text-sm text-zinc-300">
          ...
          <section className="rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,rgba(8,12,24,0.98),rgba(4,8,18,0.98))] p-8 shadow-[0_28px_90px_rgba(0,0,0,0.38)]">
            {currentUser ? (
              ...
              <>
                <div>
                  <p className="text-xs uppercase tracking-[0.22em] text-zinc-500">New account</p>
                ...
                <form className="mt-8 space-y-5" onSubmit={(event) => void handleSubmit(event)}>
                  ...
                  <div className="space-y-2">
                    <label htmlFor="display-name" className="text-sm text-zinc-300">
                      Display name
                    </label>
                    <Input
                      id="display-name"
